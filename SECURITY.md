...
Releases from 0.1.1 onward are published from CI via npm trusted
publishing (OIDC) with Sigstore provenance attestations. Verify a
release with `npm audit signatures`.
